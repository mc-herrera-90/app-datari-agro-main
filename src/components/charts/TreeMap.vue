			...
			chartOptions: {
				...
				tooltip: {
					...
					custom: function ({ series, seriesIndex, dataPointIndex, w }) {
						...
						let width_card =
							data.producto && data.producto.length > 20 ? "350px" : "300px";
						...
						return (
							...
							'<div class="subtitle-1 font-weight-light">Producto: ' +
							data.producto +
							"</div>" +
							'<div class="subtitle-1 font-weight-light">Pertinencia: ' +
							data.pertinencia +
							"</div>" +
							'<div class="subtitle-1 font-weight-light">Práctica: ' +
							data.practica +
							"</div>" +
							'<div class="subtitle-1 font-weight-light">Sellos: ' +
							data.sellos +
							"</div>" +
							'<div class="subtitle-1 font-weight-light">Producción anual: ' +
							data.produccion +
							"</div>" +
